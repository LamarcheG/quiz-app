  ...
  return (
    <>
      {isSmallScreen ? (
        <>
          {isNavOpen ? (
            <nav className="absolute z-10 h-full min-h-screen w-48 border-r border-neutral-600 bg-neutral-800">
              {/** Close button */}
              <button
                className="absolute top-2 left-2 z-10 border-none bg-neutral-900 px-4 py-3 outline-none"
            ...
            <button
              className="absolute top-2 left-2 z-10 border-none bg-neutral-800 px-3 py-2 outline-none"
